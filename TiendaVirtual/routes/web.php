...
Route::get('/prueba', function () {
	...
	// return User::get();
	// $imagen= Image::make(public_path('PlantillaTienda/images/product_1.jpg')); 
...
Route::get('/', 'Tienda\TiendaController@index')->name('index');
...
Route::resource('/admin/categoria','Admin\AdminCategoriaController')->names('Admin.Categoria')->middleware('verified');
Route::resource('/admin/producto','Admin\AdminProductoController')->names('Admin.Producto')->middleware('verified');
