		...
		<div class="home">
			...
			<div class="home_slider_container">
				<div class="owl-carousel owl-theme home_slider">
					...
					<!-- Slide -->
					@if($productos->where('slinderprincipal_Pro','Si')->first())
					@foreach ($productos->where('slinderprincipal_Pro','Si') as $producto)
					<div class="owl-item">
						<div class="background_image" style="background-image:url('{{$producto->images->first()->url}}'); "></div>
						<div class="container fill_height">
							<div class="row fill_height">
								<div class="col fill_height">
									<div class="home_container d-flex flex-column align-items-center justify-content-start">
										<div class="home_content">
											<div class="home_title">{{$producto->estado_Pro}}</div>
											<div class="home_subtitle">{{$producto->nombre_Pro}}</div>
											<div class="home_items">
												<div class="row">
													<div class="col-sm-35 offset-lg-1">														
													</div>
													<div class="col-lg-35 col-md-6 col-sm-8 offset-sm-2 offset-md-0">
														<div class="product home_item_large">
															<div class="product_tag d-flex flex-column align-items-center justify-content-center">
																<div>
																	@if($producto->porcentaje_descuento_Pro > 0)
																	<div>Oferta</div>
																	<div><?php echo( floor($producto->precio_actual_Pro) ) ?><span>.<?php echo( explode('.', number_format($producto->precio_actual_Pro, 2))[1]) ?></span>  
																	</div>
																	<del class="price-oldslider"><?php echo( floor($producto->precio_anterior_Pro) ) ?><span>.<?php echo( explode('.', number_format($producto->precio_anterior_Pro, 2))[1]) ?></span>  </del>
																	@else
															...
															<div  class="product_image"><img    src="{{$producto->images->first()->url}}" alt=""></div>
		...
		<div class="products">
			<div class="container">
				...
				<div class="row products_row">
					...
					<!-- Product -->
					@foreach ($productos->sortByDesc('visitas_Pro')->take(6) as $producto)
					<div class="col-xl-45 col-md-6">
						<div class="product">
							<div class="product_image"><img src="{{$producto->images->first()->url}}" alt=""></div>
							<div class="product_content">
								<div class="product_info d-flex flex-row align-items-start justify-content-start">
									<div>
										<div>
											...
											{!! $producto->descripcion_corta_Pro !!}</a></div>
